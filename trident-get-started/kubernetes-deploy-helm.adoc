...
----
. Use `helm install` e especifique um nome para sua implantação, como no exemplo a seguir, onde `23.04.0` está a versão do Astra Trident que você está instalando.
+
[listing]
----
