...
+
.. Crie o `kustomization.yaml` usando o seguinte comando onde _<bundle>_ está `bundle_pre_1_25` ou `bundle_post_1_25` baseado na sua versão do Kubernetes.
+
[listing]
----
cp kustomization_<bundle>.yaml kustomization.yaml
----
.. Compile o pacote usando o seguinte comando onde _<bundle>_ está `bundle_pre_1_25` ou `bundle_post_1_25` baseado na sua versão do Kubernetes.
+
[listing]
----
